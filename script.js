...
const copy = {
  es: {
    menu: 'Menú', navGroup: 'El grupo', navPlatforms: 'Plataformas', navPrinciples: 'Principios', navContact: 'Hablemos', navLabel: 'Navegación principal', languageLabel: 'Selector de idioma', brandLabel: 'Salan Capital Group, inicio',
...
function setLanguage(language) {
  ...
  const directKeys = ['menu', 'navGroup', 'navPlatforms', 'navPrinciples', 'navContact', 'heroEyebrow', 'heroTitle', 'heroIntro', 'heroLink', 'heroCta', 'heroNote', 'heroFooter1', 'heroFooter2', 'heroFooter3', 'aboutLabel', 'aboutEyebrow', 'aboutTitle', 'aboutText1', 'aboutText2', 'platformEyebrow', 'platformTitle', 'platformIntro', 'modelEyebrow', 'modelTitle', 'modelIntro', 'modelLink', 'principlesLabel', 'principlesEyebrow', 'principlesTitle', 'principlesIntro', 'contactEyebrow', 'contactTitle', 'footerTagline', 'footerCopyright'];
  const selectors = ['.menu-label', '.main-nav a:nth-child(1)', '.main-nav a:nth-child(2)', '.main-nav a:nth-child(3)', '.nav-contact', '.hero-copy .eyebrow', '.hero h1', '.hero-intro', '.hero-copy .text-link .link-label', '.cta-label', '.hero-note p', '.hero-footer span:nth-child(1)', '.hero-footer span:nth-child(2)', '.hero-footer span:nth-child(3)', '.section-label span:nth-child(2)', '.intro .eyebrow', '.intro h2', '.intro-text p:nth-child(1)', '.intro-text p:nth-child(2)', '.platforms .eyebrow', '.platforms h2', '.heading-note', '.model-copy .eyebrow', '.model-copy h2', '.model-copy > p:not(.eyebrow)', '.model-copy .text-link .link-label', '.principles .section-label span:nth-child(2)', '.principles .eyebrow', '.principles h2', '.body-copy', '.contact .eyebrow', '.contact h2', 'footer p', 'footer > span'];
  ...
  document.querySelectorAll('.platform-card > a').forEach((element, index) => element.setAttribute('aria-label', selected.platformLabels[index]));
  document.querySelector('.main-nav').setAttribute('aria-label', selected.navLabel);
  document.querySelector('.language-switcher').setAttribute('aria-label', selected.languageLabel);
  document.querySelectorAll('.brand').forEach((element) => element.setAttribute('aria-label', selected.brandLabel));
